...
let ensaladaDeFrutas = ["durazno, banana, frutilla, manzana, melon"]
for (let i = 0; i < ensaladaDeFrutas.length; i++) {
    //const element = ensaladaDeFrutas[i];
...
let edades = [21, 34, 26, 10, 8, 40]
let todasedades = 0
for (let i = 0; i < edades.length; i++) {
    todasedades += edades[i]

}

let promedio = (todasedades / edades.length);

console.log(promedio);


// Ejercicio 3: Mis amigos.
// Haga un programa que filtre el arreglo con un for y devuelva uno nuevo con el nombre de sus amigos. Si un nombre tiene exactamente 4 letras, ¡puedes estar seguro que es amigo tuyo! De lo contrario, no lo son.
// const amigo = [“Ryan”, “Kieran”, “Mark”, “Miguel”] El resultado esperado es [“Ryan”, “Mark”]
...
// Declara una función llamada saludo() que muestre una alerta de Bienvenida al visitante al invocar por la consola del navegador.
...
// 2. Dentro de la función muestra una alerta que diga quién de los números ingresados es mayor. En caso de ser iguales, tendrá que indicarlo a través de una alerta también.
// 3. Invoca la función y llena los argumentos con los números que desees.

function calculoMayor(num1, num2) {
    if (num1 > num2) {
        alert(num1 + "El numero es mayor")
    } else if (num1 < num2) {
        alert(num1 + "El numero es menor")
    } else {
        alert("Son iguales")
    }
...
console.log(calculoMayor(2, 3));


// Ejercicio 7: Mis amigos.
// 1. Declara una función que se llame filtrarAmigos() y pásale como parámetro (arr).
// 2. La función deberá filtrar el arreglo y devolver uno nuevo con el nombre de sus amigos. Si un nombre tiene exactamente 4 letras, ¡puedes estar seguro que es
// amigo! De lo contrario, no lo son.
// const amigo1 = [“Ryan”, “Kieran”, “Mark”, “Miguel”]
// const amigo2 = [“Ringo”,”Jhon”,”Paul”,”George”,”Ada”,”Marie”]
// El resultado esperado para amigo1 es [“Ryan”, “Mark”] El resultado esperado para amigo2 es [”Jhon”,”Paul”]
...
// 1. Crea un función tirarDado() que cuando sea ejecutada en la consola tire un resultado aleatorio del siguiente array: const dado = [1,2,3,4,5,6];
// 2. Deberás codear dentro del bloque de la función, el lanzamiento aleatorio a través de un math.ramdom (pregúntale a san Google como funciona este señor).
...
const toDolist = {
    ...
    dia: "viernes",
    productos: ["crema", "bebida de almendras", "cafe", "chocolate"],
...
// Muchas veces vamos a tener estructuras más complejas de objetos y nosotros vamos a tener que acordarnos de todos los conceptos que hemos visto hasta ahora. Copia y pega esto en tu archivo JS
// const superHeroes = {
...
// Probablemente te acuerdes de este ejercicio que ya lo hemos trabajado antes, pues ahora filtraremos los amigos con el método filter(). Recuerda que el programa debe filtrar el arreglo y devolver uno nuevo con el nombre de sus amigos. Si un nombre tiene exactamente 4 letras, ¡puedes estar seguro que es amigo tuyo! De lo contrario, no lo son.
// const amigo = [“Ryan”, “Kieran”, “Mark”, “Miguel”]
...
// Tenemos un arreglo llamado frases con varias sentencias al azar. Usá la función map() para que cada frase empiece y termine con signos de exclamación.
// const frases = ['Labore sea dolor.', 'Justo rebum dolor.', 'Stet lorem amet.'];
// El resultado esperado es:
// console.log(frases); // ['Labore sea dolor.', 'Justo rebum dolor.', 'Stet lorem amet.'] console.log(frasesExclamadas); // [ '¡Labore sea dolor.!', '¡Justo rebum dolor.!', '¡Stet lorem amet.!' ]
